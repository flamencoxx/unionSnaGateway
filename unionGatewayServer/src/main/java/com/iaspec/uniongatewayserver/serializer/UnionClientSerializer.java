 ...
 */
public class UnionClientSerializer extends AbstractPooledBufferByteArraySerializer {

    public UnionClientSerializer() {
        super();
    }

    public UnionClientSerializer(int maxMessageSize){
        super();
